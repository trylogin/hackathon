...
while True:
    ...
    blinked, horizontal_ratio_l, horizontal_ratio_r, vertical_ratio_l, vertical_ratio_r, left, right, look_right, look_left, look_down, look_up, look_center = get_Gaze_Tracking_Coords(new_frame)
